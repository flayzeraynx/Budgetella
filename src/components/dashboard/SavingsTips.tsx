  ...
  const generateTips = (): SavingsTip[] => {
    ...
    if (transactions.length >= 5) {
      ...
      if (topCategory) {
        ...
        if (percentage > 30) {
          const title = t.dashboard.highSpendingTitle.replace('{category}', categoryName);
          const description = t.dashboard.highSpendingDesc
      ...
      if (smallExpenses.length > 10) {
        tips.push({
          id: 2,
          title: t.dashboard.smallExpensesTitle,
          description: t.dashboard.smallExpensesDesc,
          dateCreated: new Date(),
          isRead: false
        });
      }
    ...
    if (tips.length === 0) {
      tips.push({
        id: 3,
        title: t.dashboard.emergencyFundTitle,
        description: t.dashboard.emergencyFundDesc,
        dateCreated: new Date(),
        isRead: false
      });
      ...
      tips.push({
        id: 4,
        title: t.dashboard.budgetRuleTitle,
        description: t.dashboard.budgetRuleDesc,
        dateCreated: new Date(),
        isRead: false
      });
      ...
      tips.push({
        id: 5,
        title: t.dashboard.trackSpendingTitle,
        description: t.dashboard.trackSpendingDesc,
        dateCreated: new Date(),
        isRead: false
      });
      ...
      tips.push({
        id: 6,
        title: t.dashboard.payYourselfTitle,
        description: t.dashboard.payYourselfDesc,
        dateCreated: new Date(),
        isRead: false
      });
    }
  ...
  return (
    <div className="bg-secondary-50 dark:bg-secondary-800 rounded-lg p-4 my-4 text-center">
      <div className="flex items-center justify-center mb-2">
        ...
        <span className="text-sm font-medium text-secondary-600 dark:text-secondary-300">{t.dashboard.savingsTip}</span>
      </div>
