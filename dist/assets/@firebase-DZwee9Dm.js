 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xl="storage";function $m(n=Ja(),t){n=Vt(n);const r=Qa(n,xl).getImmediate({identifier:t}),s=za("storage");return s&&mm(r,...s),r}function mm(n,t,e,r={}){fm(n,t,e,r)}function gm(n,{instanceIdentifier:t}){const e=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new pm(e,r,s,t,Ya)}function _m(){mn(new Ve(xl,gm,"PUBLIC").setMultipleInstances(!0)),me(Ba,qa,""),me(Ba,qa,"esm2017")}_m();export{kp as A,Om as B,Ve as C,Lm as D,Ka as E,ye as F,Mm as G,Fm as H,km as I,Um as J,qm as K,Wa as L,Sm as M,Ya as S,st as T,mn as _,Am as a,Im as b,Xa as c,Vt as d,zs as e,bm as f,Em as g,z as h,Tm as i,Ic as j,Ja as k,Qa as l,bc as m,ur as n,wm as o,Rm as p,Pm as q,me as r,vm as s,Rh as t,Vm as u,$m as v,xm as w,Dm as x,Nm as y,Bm as z};
